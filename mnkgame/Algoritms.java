...
// @@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@
  ...
  // Scorre tu
  public static boolean onlyCutoff (TreeNode in_primoFiglio, boolean in_myTurn) {
    if (in_myTurn) {
      while (in_primoFiglio != null) {
        if (in_primoFiglio.getBeta() < in_primoFiglio.getAlpha()) return false;   // Dobbiamo dare un alpha al nodo padre, e vi è almeno una situazione che non sia cutoff (per alpha)
        in_primoFiglio = in_primoFiglio.getNext();
      }
      return true;
    } else {
      while (in_primoFiglio != null) {
        if (in_primoFiglio.getBeta() > in_primoFiglio.getAlpha()) return false;   // Dobbiamo ritornare un valore beta al padre, e vi è almeno una situazione diversa dal cutoff (per beta)
        in_primoFiglio = in_primoFiglio.getNext();
      }
    }
    return true;
